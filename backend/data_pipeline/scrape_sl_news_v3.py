...
def ingest_to_db(items: list, source_slug: str, source_weight: float, db) -> tuple:
...
def fetch_rss_articles(domain: str, queries: list, slug: str) -> list:
...
def fetch_article_body(url: str, body_sels: list) -> str:
...
def scrape_general_google_news(db) -> tuple:
    """
...
def scrape_government_advisories(db) -> tuple:
    """
...
def scrape_news_sites(db) -> tuple:
